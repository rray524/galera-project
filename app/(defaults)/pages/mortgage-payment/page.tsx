    ...
    <div className="max-w-lg mx-auto p-8 bg-white shadow-lg rounded-lg my-10">
      ...
      <form className="space-y-6">
        ...
        <button
          ...
          className="w-full bg-teal-600 text-white py-2 px-4 rounded-md shadow-sm hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500"
      ...
      {results.mortgagePayment !== null && results.totalInterest !== null && (
        <div
          id="results"
          className="mt-8 p-4 bg-gradient-to-r from-teal-50 to-teal-100 rounded-lg shadow-md"
        >
          <h2 className="text-2xl font-bold mb-4 text-teal-800">Results:</h2>
